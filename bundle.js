...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Albums = __webpack_require__(207);

	var _Albums2 = _interopRequireDefault(_Albums);

	var _AlbumInfo = __webpack_require__(209);
	...
	var routes = _react2.default.createElement(
		...
		_react2.default.createElement(
			_reactRouter.Route,
			{ path: '/', component: _Albums2.default },
			_react2.default.createElement(_reactRouter.Route, { path: '/album/:_id', component: _AlbumInfo2.default })
		)
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AlbumTile = __webpack_require__(212);
	...
	var Albums = (function (_React$Component) {
		...
		function Albums(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Albums).call(this, props));
			...
			$.getJSON('/data/all.json', function (result) {
				_this.setState({
					albums: result
				});
			});

			_this.calcRows = _this.calcRows.bind(_this);
			_this.calcNumPerRow = _this.calcNumPerRow.bind(_this);
		...
		_createClass(Albums, [{
			key: 'calcNumPerRow',
			value: function calcNumPerRow() {
				var imageWidth = _config2.default.IMAGE_WIDTH + _config2.default.IMAGE_MARGIN * 2;
			...
			value: function calcRows() {
				...
				var rows = this.state.albums.reduce(function (rows, album, index) {
			...
			value: function componentDidMount() {
				...
				window.addEventListener('resize', function () {
					_this2.setState({ viewportWidth: window.innerWidth });
				});
			}
		}, {
			...
			key: 'renderRow',
			value: function renderRow(row, j) {
				var _this3 = this;

				var albums = row.map(function (album, i) {
					return _react2.default.createElement(_AlbumTile2.default, { album: album, key: i, params: _this3.props.params });
				});

				var currentId = this.props.params._id;
				var lastChildId = this.state.lastChildId;

				var hasCurrent = row.filter(function (album) {
					return album._id === currentId;
				}).length > 0;
				var hadCurrent = row.filter(function (album) {
					return album._id === lastChildId;
				}).length > 0;
				...
				return _react2.default.createElement(
					...
					{ key: j },
					albums,
					hasCurrent ? _react2.default.createElement(_AlbumInfo2.default, { params: this.props.params, albums: this.state.albums }) : null,
					hadCurrent && !sameRow ? _react2.default.createElement(_AlbumInfo2.default, { params: { _id: lastChildId }, albums: this.state.albums, old: true }) : null
				);
			}
		}, {
			key: 'render',
		...
		_createClass(AlbumInfo, [{
			...
			value: function componentWillMount() {
				...
				var album = this.props.albums.filter(function (album) {
					return album._id === _this2.props.params._id;
				})[0];
				(0, _Colors2.default)(album.image).then(function (color) {
			...
			value: function componentDidUpdate() {
				...
				if (this.state.animate) {
					...
					var album = this.props.albums.filter(function (album) {
						return album._id === _this3.props.params._id;
					})[0];
					(0, _Colors2.default)(album.image).then(function (color) {
			...
			value: function render() {
				...
				var album = this.props.albums.filter(function (album) {
					return album._id === _this5.props.params._id;
				})[0];
				var tracks = album.tracks.map(function (track, i) {
					return _react2.default.createElement(
						'li',
						{ key: i },
						track.name,
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ ref: 'container', style: { padding: 50 } },
						_react2.default.createElement(
							'h1',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ColorThief = __webpack_require__(211);
	...
	function getColor(src) {
	  return new Promise(function (resolve, reject) {
	    ...
	    img.onload = function () {
	      ...
	      var _thief$getColor = thief.getColor(img);

	      var _thief$getColor2 = _slicedToArray(_thief$getColor, 3);

	      var r = _thief$getColor2[0];
	      var g = _thief$getColor2[1];
	      var b = _thief$getColor2[2];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AlbumTile = (function (_React$Component) {
		_inherits(AlbumTile, _React$Component);

		function AlbumTile() {
			_classCallCheck(this, AlbumTile);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(AlbumTile).apply(this, arguments));
		}

		_createClass(AlbumTile, [{
			key: 'render',
			value: function render() {
				var current = this.props.album._id === this.props.params._id;
				var wrapStyles = {
					width: _config2.default.IMAGE_WIDTH,
					height: _config2.default.IMAGE_WIDTH,
					backgroundImage: 'url(' + this.props.album.image + ')',
					backgroundSize: 'cover',
					margin: _config2.default.IMAGE_MARGIN,
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_reactRouter.Link, { to: '/album/' + this.props.album._id, style: wrapStyles }),
					current ? _react2.default.createElement(_Arrow2.default, { album: this.props.album }) : null
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Arrow = (function (_React$Component) {
		...
		function Arrow(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Arrow).call(this, props));
